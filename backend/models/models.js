...
export const Donations = mongoose.model('Donations', bloodDonations);
...
export const Requests = mongoose.model('Requests', bloodRequests);
...
export const BloodBank = mongoose.model('BloodBanks', bloodBankSchema);
...
export const Camp = mongoose.model('Camps', campSchema);



// Exports
// exports = { User, Donations, Requests, BloodBank, Camp }